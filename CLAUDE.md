...
Operator/
  CLAUDE.md                        # 이 파일
  ko/                              # 한국어 학습 노트 (GitBook 한국어 variant)
    Readme.md                      # GitBook 메인 페이지
    SUMMARY.md                     # GitBook 사이드바 목차
    notes/                         # 학습 노트 (6학년도 이해 가능한 수준)
      ...
      08-Owner-Reference와-Garbage-Collection.md  # Owner Reference
  ...
  en/                              # English learning notes (GitBook English variant)
    Readme.md                      # GitBook main page
    SUMMARY.md                     # GitBook sidebar TOC
    notes/                         # English translations of all notes
