...
- [x] Finalizer 패턴 -- notes/08
- [ ] Owner Reference와 Garbage Collection
- [x] Webhook (Validating / Mutating) -- notes/09, 09-1, 09-2, 09-3, 09-4
- [ ] 에러 핸들링 및 Retry 전략
...
Operator/
  ...
  notes/                           # 학습 노트 (6학년도 이해 가능한 수준)
    ...
    08-Finalizer.md                # Finalizer 패턴, 정리 로직
    09-Webhook.md                  # Webhook 개념 (Admission Controller)
    09-1-Mutating-Webhook.md       # Mutating Webhook 개념
    09-2-Mutating-Webhook-구현.md   # Mutating Webhook 구현 실습
    09-3-Validating-Webhook.md     # Validating Webhook 개념
    09-4-Validating-Webhook-구현.md # Validating Webhook 구현 실습
