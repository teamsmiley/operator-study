...
- [x] 도구 설치 (Go, Docker, kubectl, k3d, kubebuilder) -- notes-6th-grade/00-environment-setup
- [x] k3d로 로컬 클러스터 생성 및 kubectl 연결 확인 -- notes-6th-grade/00-environment-setup
- [x] CRD와 CR 이해 (kubebuilder 없이 직접 실습) -- notes-6th-grade/01, 01-1
- [x] Controller 패턴 이해 (Reconciliation Loop, Watch) -- notes-6th-grade/02

### Phase 2: 첫 번째 Operator 만들기 (만들면서 배우기)

- [x] kubebuilder로 프로젝트 생성, 핵심 파일 2개 수정 -- notes-6th-grade/03
- [x] 빌드 및 배포 (make install/run/deploy) -- notes-6th-grade/04
